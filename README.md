...
- **Stickman Brawl** — real-time multiplayer arena fighter. Fight other players
  and AI mobs that fall from the sky. Features weapon pickups (club, bow,
  spear, wand), L-platform traps (trapdoors + wall push), flying mobs, and
  proportional kill-reward scoring. Controls: arrow keys to move/jump/duck,
  Z/X/C/Space for punch/kick/roundhouse/power attack, Z to swing equipped
  weapons. Mob spawn rate accelerates over time — survive as long as you can.
